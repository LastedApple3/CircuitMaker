...
public static class ComponentRegisterer
{
    ...
    {
        ReadWriteImplementation.Constructors.Add(VarInpAndComponent.ID, VarInpAndComponent.Constructor);
        ReadWriteImplementation.Constructors.Add(VarInpOrComponent.ID, VarInpOrComponent.Constructor);
        ReadWriteImplementation.Constructors.Add(VarInpXorComponent.ID, VarInpXorComponent.Constructor);
        ReadWriteImplementation.Constructors.Add(VarInpNandComponent.ID, VarInpNandComponent.Constructor);
        ReadWriteImplementation.Constructors.Add(VarInpNorComponent.ID, VarInpNorComponent.Constructor);
        ReadWriteImplementation.Constructors.Add(VarInpXnorComponent.ID, VarInpXnorComponent.Constructor);

        ReadWriteImplementation.Constructors.Add(BufferComponent.ID, BufferComponent.Constructor);
        ...
        ReadWriteImplementation.Constructors.Add(BoardInputComponent.ID, BoardInputComponent.Constructor);
        ReadWriteImplementation.Constructors.Add(BoardOutputComponent.ID, BoardOutputComponent.Constructor);
        ReadWriteImplementation.Constructors.Add(BoardBidirComponent.ID, BoardBidirComponent.Constructor);
        ReadWriteImplementation.Constructors.Add(BoardContainerComponent.ID, BoardContainerComponent.Constructor);



        ReadWriteImplementation.DefaultDetails.Add(VarInpAndComponent.ID, VarInpAndComponent.DefaultDetails);
        ReadWriteImplementation.DefaultDetails.Add(VarInpOrComponent.ID, VarInpOrComponent.DefaultDetails);
        ReadWriteImplementation.DefaultDetails.Add(VarInpXorComponent.ID, VarInpXorComponent.DefaultDetails);
        ReadWriteImplementation.DefaultDetails.Add(VarInpNandComponent.ID, VarInpNandComponent.DefaultDetails);
        ReadWriteImplementation.DefaultDetails.Add(VarInpNorComponent.ID, VarInpNorComponent.DefaultDetails);
        ReadWriteImplementation.DefaultDetails.Add(VarInpXnorComponent.ID, VarInpXnorComponent.DefaultDetails);

        ReadWriteImplementation.DefaultDetails.Add(BufferComponent.ID, BufferComponent.DefaultDetails);
        ...
        ReadWriteImplementation.DefaultDetails.Add(BoardInputComponent.ID, BoardInputComponent.DefaultDetails);
        ReadWriteImplementation.DefaultDetails.Add(BoardOutputComponent.ID, BoardOutputComponent.DefaultDetails);
        ReadWriteImplementation.DefaultDetails.Add(BoardBidirComponent.ID, BoardBidirComponent.DefaultDetails);
...
interface ISingInpComponent : IComponent
{
    Pos GetInpOffset();
    Pos GetInpPosition();
    Pin GetInpPin();
...
interface IMultInpComponent : IComponent
{
    Pos[] GetInpOffsets();
    Pos[] GetInpPositions();
    Pin[] GetInpPins();
...
interface ISingOutpComponent : IComponent
{
    Pos GetOutpOffset();
    Pos GetOutpPosition();
    Pin GetOutpPin();
...
interface IMultOutpComponent : IComponent
{
    Pos[] GetOutpOffsets();
...
interface ISingInpSingOutpComponent : ISingInpComponent, ISingOutpComponent { }
interface ISingInpMultOutpComponent : ISingInpComponent, IMultOutpComponent { }
interface IMultInpSingOutpComponent : IMultInpComponent, ISingOutpComponent { }
interface IMultInpMultOutpComponent : IMultInpComponent, IMultOutpComponent { }

abstract class SingInpNoneOutpBaseComponent : BaseComponent, ISingInpComponent
{
...
abstract class MultInpNoneOutpBaseComponent : BaseComponent, IMultInpComponent
{
...
abstract class NoneInpSingOutpBaseComponent : BaseComponent, ISingOutpComponent
{
...
abstract class NoneInpMultOutpBaseComponent : BaseComponent, IMultOutpComponent
{
...
abstract class SingInpSingOutpBaseComponent : BaseComponent, ISingInpSingOutpComponent
{
    public abstract Pos GetInpOffset();
...
abstract class SingInpMultOutpBaseComponent : BaseComponent, ISingInpMultOutpComponent
{
    public abstract Pos GetInpOffset();
...
abstract class MultInpSingOutpBaseComponent : BaseComponent, IMultInpSingOutpComponent
{
    public abstract Pos[] GetInpOffsets();
...
abstract class MultInpMultOutpBaseComponent : BaseComponent, IMultInpMultOutpComponent
{
    public abstract Pos[] GetInpOffsets();
...
abstract class BaseBufferComponent : MultInpSingOutpBaseComponent
{
...
class BufferComponent : BaseBufferComponent
{
...
class NotComponent : BaseBufferComponent
{
    public override Pos[] GetInpOffsets()
    {
        return new Pos[] { new Pos(-1, 0) };
...
class TristateBufferComponent : BaseBufferComponent
{
    public override Pos[] GetInpOffsets()
    {
        return new Pos[] {
    ...
    public override void Tick()
    {
        State activationState = GetInpPins()[1].GetStateForComponent();

        if (activationState == State.HIGH)
        {
            GetOutpPin().SetState(GetInpPins()[0].GetStateForComponent());
        }
        else if (activationState == State.LOW || activationState == State.FLOATING)
        {
            GetOutpPin().SetState(State.FLOATING);
        }
        else
        {
            GetOutpPin().SetState(State.ILLEGAL);
        }
    }
    ...
    public override void Render(Graphics graphics, bool simulating, ColourScheme colourScheme)
    {
        InpOutpTools.DrawInpLine(graphics, simulating, GetInpOffsets()[0], colourScheme, this);

        InpOutpTools.DrawInpOutpLine(graphics, simulating, GetInpOffsets()[1], new PointF(0, 0), colourScheme, this);
...
abstract class BaseVarInpComponent : MultInpSingOutpBaseComponent, ISettingsComponent
{
    ...
    protected abstract State Accumulator(State state1, State state2);
...
class VarInpAndComponent : BaseVarInpComponent
{
    public VarInpAndComponent(int inpCount) : base(inpCount) { }

    protected override State Accumulator(State state1, State state2)
    {
...
class VarInpOrComponent : BaseVarInpComponent
{
...
class VarInpXorComponent : BaseVarInpComponent
{
...
class VarInpNandComponent : BaseVarInpComponent
{
...
class VarInpNorComponent : BaseVarInpComponent
{
...
class VarInpXnorComponent : BaseVarInpComponent
{
...
class FixedStateComponent : NoneInpSingOutpBaseComponent, ISettingsComponent
{
    ...
    protected EnumSettingDescription<State> stateSettingDesc;
    ...
    public FixedStateComponent(State state)
    {
        OutputState = state;
    }
    ...
    public static string DefaultDetails = $"{(int)State.LOW}";
    ...
    public static IComponent Constructor(string details)
    {
        ...
        {
            return new FixedStateComponent((State)outputState);
        }
    ...
    {
        stateSettingDesc = new EnumSettingDescription<State>($"What is the {getOutputDescriptor()} state for this component?", OutputState);
...
class UserToggleInpComponent : NoneInpSingOutpBaseComponent, ISettingsComponent, IInteractibleComponent
{
    protected State OutputState, StartState, OtherState;
    ...
    protected EnumSettingDescription<State> startStateSettingDesc;
    protected EnumSettingDescription<State> otherStateSettingDesc;
    ...
    public UserToggleInpComponent(State startState, State otherState)
    {
    ...
    public static string DefaultDetails = $"{(int)State.LOW},{(int)State.HIGH}";
    ...
    public static IComponent Constructor(string details)
    {
        ...
        {
            return new UserToggleInpComponent((State)startState, (State)otherState);
        }
    ...
    public virtual ISettingDescription[] GetSettingDescriptions()
    {
        startStateSettingDesc = new EnumSettingDescription<State>($"What is the starting {getOutputDescriptor()} state for this component?", StartState);
        otherStateSettingDesc = new EnumSettingDescription<State>($"What is the other {getOutputDescriptor()} state for this component?", OtherState);
...
class UserPulseInpComponent : NoneInpSingOutpBaseComponent, IInteractibleComponent, ISettingsComponent
{
    public override Pos GetOutpOffset()
    {
        return new Pos(2, 0);
    ...
    protected State NormalState, PulseState;

    protected PositiveIntSettingDescription PulseLengthSettingDesc;
    protected EnumSettingDescription<State> NormalStateSettingDesc, PulseStateSettingDesc;

    public static string ID = "PULSE";
    public static string DefaultDetails = $"{20},{(int)State.LOW},{(int)State.HIGH}";
    ...
    public UserPulseInpComponent(int pulseLength, State normalState, State pulseState)
    {
    ...
    public static IComponent Constructor(string details)
    {
        ...
        {
            return new UserPulseInpComponent(pulseLength, (State)normalState, (State)pulseState);
        }
    ...
    public virtual ISettingDescription[] GetSettingDescriptions()
    {
        ...
        NormalStateSettingDesc = new EnumSettingDescription<State>("What state should this component output while not pulsing?", NormalState);
        PulseStateSettingDesc = new EnumSettingDescription<State>("What state should this component output while pulsing?", PulseState);
...
class LogicProbeComponent : SingInpNoneOutpBaseComponent, IGraphicalComponent
{
    ...
    public void RenderGraphicalElement(Graphics graphics, bool simulating, ColourScheme colourScheme)
    {
        ...
        if (simulating)
        {
            State state = GetInpPin().GetStateForDisplay();
...
class SevenSegmentComponent : MultInpNoneOutpBaseComponent, IGraphicalComponent
{
    public override RectangleF GetComponentBounds()
    {
    ...
    private void DrawSegment(Graphics graphics, bool simulating, ColourScheme colourScheme, PointF point1, PointF point2, State state)
    {
        GraphicsPath path;
...
class BoardInputComponent : UserToggleInpComponent, IBoardInputComponent
{
    ...
    public BoardInputComponent(string name, State startDefaultState, State otherDefaultState) : base(startDefaultState, otherDefaultState)
    {
        ComponentName = name;
    ...
    public BoardInputComponent(string name, State startDefaultState, State otherDefaultState, Board.InterfaceLocation interfaceLocation) : base(startDefaultState, otherDefaultState)
    {
        ComponentName = name;
    ...
    //public new static string DefaultDetails = $"I0,{(int)State.LOW},{(int)State.HIGH},{(byte)Board.InterfaceLocation.SideEnum.Left},{0}";
    public new static string DefaultDetails = $"I0,{(int)State.LOW},{(int)State.HIGH}";
    ...
    public override void Tick()
    {
        State prevState = GetOutpPin().GetStateForWireComponent();
    ...
    public new static BoardInputComponent Constructor(string details)
    {
        ...
        {
            return new BoardInputComponent(strings[0], (State)startDefaultState, (State)otherDefaultState /*, new Board.InterfaceLocation((Board.InterfaceLocation.SideEnum)(byte)sideInt, distInt) */);
        }
...
class BoardOutputComponent : SingInpNoneOutpBaseComponent, IBoardOutputComponent, ISettingsComponent
{
    private string ComponentName;
    ...
    public override void Tick()
    {
        ...
        if (externalPin != null)
        {
            State prevState = externalPin.GetStateForWireComponent();
...
class BoardBidirComponent : SingInpSingOutpBaseComponent, IBoardInputComponent, IBoardOutputComponent, ISettingsComponent
{
    private string ComponentName;
    private State DefaultExternalState;
    private Pin externalPin = null;

    private NameSettingDescription nameSettingDesc;
    private EnumSettingDescription<State> defaultStateSettingDesc;
    ...
    public BoardBidirComponent(string name, State defaultState)
    {
        ComponentName = name;
    ...
    public BoardBidirComponent(string name, State defaultState, Board.InterfaceLocation interfaceLocation)
    {
        ComponentName = name;
    ...
    //public static string DefaultDetails = $"B0,{(int)State.LOW},{(byte)Board.InterfaceLocation.SideEnum.Top},{0}";
    ...
    public override void Tick()
    {
        State prevIntState = GetOutpPin().GetStateForWireComponent();
        ...
        {
            State prevExtState = externalPin.GetStateForWireComponent();
    ...
    public static BoardBidirComponent Constructor(string details)
    {
        ...
        {
            return new BoardBidirComponent(strings[0], (State)stateInt /*, new Board.InterfaceLocation((Board.InterfaceLocation.SideEnum)sideInt, distInt) */);
        }
    ...
    {
        nameSettingDesc = new NameSettingDescription("What is this component called?", ComponentName);
        defaultStateSettingDesc = new EnumSettingDescription<State>("What is the simulated external state of this component?", DefaultExternalState);
    ...
    public override void Render(Graphics graphics, bool simulating, ColourScheme colourScheme)
    {
        InpOutpTools.DrawInpOutpLine(graphics, simulating, offset, new PointF(offset.X, offset.Y - 1.5F), colourScheme, this);
...
class BoardContainerComponent : MultInpMultOutpBaseComponent, IBoardContainerComponent
{
    ...
    public override void Render(Graphics graphics, bool simulating, ColourScheme colourScheme)
    {
        ...
        foreach (IBoardInterfaceComponent interfaceComp in InternalBoard.GetInterfaceComponents())
        {
            ...
            InpOutpTools.DrawInpOutpLine(graphics, simulating, offsetInfo.Item1.Add(offsetInfo.Item2), new PointF(otherOffset.X, otherOffset.Y), colourScheme, this);
        }
